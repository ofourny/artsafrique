...
class Meetanshi_ImageClean_Adminhtml_ProductimagecleanController extends Mage_Adminhtml_Controller_Action
{
    public function indexAction()
    {
        $this->_title($this->__('imageclean'))->_title($this->__('Product Unused Images'));
        $this->loadLayout();
    ...
    {
        Mage::helper("imageclean")->Productunusedimage();
        $this->_redirect('*/*/index');
    }
